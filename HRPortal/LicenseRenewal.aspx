...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <%
    ...
    <div class="panel panel-primary">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox runat="server" ID="NameCollab" CssClass="form-control span3" placeholder="Name" />
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox CssClass="form-control" runat="server" ID="CapitalBudget" TextMode="Number"/>
                         <asp:RequiredFieldValidator Display="dynamic" runat="server" ID="RequiredFieldValidator7" ControlToValidate="CapitalBudget" InitialValue="--Select--" ErrorMessage="Present Capital Budgtet, it cannot be empty!" ForeColor="Red" />
                           <asp:RangeValidator  Display="dynamic" ID="RangeValidator2" runat="server" ErrorMessage="Value cannot be negative or 0" forecolor="Red" ControlExtender="numberFilterMaskedEditExtender" controltovalidate="CapitalBudget" minimumvalue="1"  maximumvalue="20000000" type="Double"></asp:RangeValidator> 
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox CssClass="form-control" runat="server" ID="recurrentBudget" TextMode="Number"/>
                         ...
                         <asp:RangeValidator  Display="dynamic" ID="RangeValidator1" runat="server" ErrorMessage="Value cannot be negative or 0" forecolor="Red" ControlExtender="numberFilterMaskedEditExtender" controltovalidate="recurrentBudget" minimumvalue="1"  maximumvalue="20000000" type="Double"></asp:RangeValidator> 
                    </div>
                </div>
                     <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label>Academic Qualification and Specialization:</label> <span class="asterisk" style="color: red">*</span>                     
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        <label>Evidence of accreditation of the proposed academic programme<i>(pdf only)  </i></label>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox CssClass="form-control" runat="server" ID="LocalAcademic" TextMode="MultiLine" Rows="3" />
                         <asp:RequiredFieldValidator Display="dynamic" runat="server" ID="RequiredFieldValidator12" ControlToValidate="LocalAcademic"  ErrorMessage="Principle Academic Focuss, it cannot be empty!" ForeColor="Red" />
                    </div>
                </div>
                  <div class="col-md-6">
                    <div class="form-group">
                        <label>Principle Research Focus. <span class="text-danger">*</span></label>
                        <asp:TextBox CssClass="form-control" runat="server" ID="localPrinciple" TextMode="MultiLine" Rows="3" />
                         <asp:RequiredFieldValidator Display="dynamic" runat="server" ID="RequiredFieldValidator13" ControlToValidate="localPrinciple"  ErrorMessage="Principle Research Focus, it cannot be empty!" ForeColor="Red" />
                    </div>
                </div>
                   <div class="col-md-6">
                    <div class="form-group">
                        <label>Envisaged benefit of the collaboration for education in Kenya genrally.<span class="text-danger">*</span></label>
                      ...
                      <div class="col-md-6">
                    <div class="form-group">
                        <label>Explanation of accreditation of the proposed academic programme.<i><strong>(in some countries, once a university is accredited they have powers to mount programmes based on their internal policies and frameworks)</label>
        ...
        <div class="panel-footer">
               ...
               <asp:Button runat="server" ID="Nexttostep2" CssClass="btn btn-success pull-right" Text="Next" CausesValidation="false" OnClick="addapplication_Click" Visible="true"/>
     ...
     <div class="panel-footer">     
      ...
      <div class="row">
        <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="Home.aspx">Dashboard</a></li>
                <li class="breadcrumb-item active">Foreign Institutions Details</li>
            </ol>
        </div>
    </div>
        <div class="panel panel-primary">
            <div class="panel-heading">
                Foreign Institution/University Details <i><strong></strong></i>
            ...
            <div class="panel-body">
                <div runat="server" id="physicalLocations"></div>
                 <p style="align-content: center"><i><strong>--Details of the local/foreign Institution seeking to collaborate with a local institution--</strong></i></p>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Name of the foreign/local institution <span class="text-danger">*</span></label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Physical Address Number<span class="text-danger">*</span></label>
                ...
                <div class="col-md-6">
                   ...
                   <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label>Principle Academic Focus. <span class="text-danger">*</span></label>
                        <asp:TextBox CssClass="form-control" runat="server" ID="ForeignAcademic" TextMode="MultiLine" Rows="3" />
                         <asp:RequiredFieldValidator Display="dynamic" runat="server" ID="RequiredFieldValidator23" ControlToValidate="ForeignAcademic"  ErrorMessage="Principle Academic Focus., it cannot be empty!" ForeColor="Red" />
                    </div>
                </div>
                  <div class="col-md-6">
                    <div class="form-group">
                        <label>Principle Research Focus. <span class="text-danger">*</span></label>
                        <asp:TextBox CssClass="form-control" runat="server" ID="ForeignResearch" TextMode="MultiLine" Rows="3" />
                           <asp:RequiredFieldValidator Display="dynamic" runat="server" ID="RequiredFieldValidator24" ControlToValidate="ForeignResearch"  ErrorMessage="Principle Research Focus., it cannot be empty!" ForeColor="Red" />
                    </div>
                </div>
            </div>             
            </div>
      ...
      <div class="row" style="align-content:center">
                <asp:Button runat="server" ID="foreignDetailz" CssClass="btn btn-warning center-block" Text="save Institution Details" OnClick="ForeignDetails_Click" Visible="true"/>
               
            </div>

   
            <div class="panel-footer">
             <asp:Button runat="server" CssClass="btn btn-success pull-right" Text="Next" id="ForeignDetails" OnClick="nextstep_Click" CausesValidation="false" Visible="false"/>
 ...
 <%--       <div class="row">
  ...
  <%--  <div class="panel-body">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
             Institution Equipment and teaching materials
        ...
        <div class="panel-body">
            <div runat="server" id="Div2"></div>
                ...
                <div class="col-md-12 col-lg-12">
                     <input type="button" id="btn_apply_SubmitServices" class="btn btn-success center-block btn_apply_SubmitServices" name="btn_apply_SubmitServices" value="Submit Selected equipment and teaching materials" />                   
                </div>
            </div>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            Academic Staff <i><strong>(List of names of academic and relevant support staff)</strong></i>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label class="span2">Qualification<span style="color: red">*</span></label>
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label class="span2">Experience <i>(Years)</i><span style="color: red">*</span></label>
            ...
            <table id="example5" class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><% =item.Remarks %></td>                      
                        <td><% =item.Qualification_Type +" "+ item.Qualification %></td>
                        <td><% =item.Number %></td>
  ...
  <%
            ...
            <div class="row">
             ...
             <div class="panel-footer">
                <asp:Button runat="server" CssClass="btn btn-warning pull-left" Text="Previous" OnClick="previousstep_Click" />
                   <asp:Button runat="server" CssClass="btn btn-success pull-right btn2" Text="Next" ID="previewReport" OnClick="previewReport_Click" Visible="false" />   
                <div class="clearfix"></div>
            </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            Declaration<div class="pull-right"><i class="fa fa-angle-left"></i>Step 10 of 10<i class="fa fa-angle-right"></i></div>
            <div class="clearfix"></div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        %>
                        <p>
                            I hereby apply for the Commission's authority for Collaboration with the University known as 
                       <b>  <%=item.Name_of_Foreign_University %></b>
                        ...
                        <b> <%=item.Email_Address %></b>
                            Website 
                       <b>   <%=item.Web_site %></b>
                            for purposes of offering a joint programme known as 
        ...
        <div class="panel-footer">
          <asp:Button runat="server" CssClass="btn btn-warning pull-left" Text="Previous" ID="previousSteps" CausesValidation="false" OnClick="previousSteps_Click1" />
